...
%========================================================================================
%	POINT 1 (the reclassification inherits the predictive reading)
%========================================================================================
% Verbal cues: two readings of "X explains the cross section". The verdicts on the
% zoo presume every anomaly claimed prediction.
% SAY slowly, the Novy-Marx line, "the paper's inflated verdict on operating
% profitability CONFIRMS his claim rather than debunks it". That is the punch.
% Momentum and accruals are the honest counterexamples, genuine within firm
% claims, there the paper's benchmark is exactly right.
\begin{frame}{Point 1: The verdicts presume every anomaly claimed prediction}
\lead{Two readings of ``$X$ explains the cross section''}
\bit\itemsep2pt
  \item \higr{$X$ as a signal} \quad a within firm \emph{change} in $X$ predicts returns, \emph{bias} is the \higr{right} word for the wedge
  \item \hird{$X$ as a type} \quad high $X$ \emph{firms} earn persistently different returns, \emph{bias} is the \hird{wrong} word
\eit
\svs
\lead{Part of the literature the paper reclassifies made type claims}
\bit\itemsep2pt
  \item \citet{novymarx2013} \quad profitable \emph{firms} earn higher average returns. The ``inflated'' verdict on operating profitability confirms this claim rather than debunks it
  \item \citet{famafrench2015} \quad profitability and investment premia are return differences \emph{across} firm types, and \citet{danieltitman1997} argue explicitly about characteristic \emph{levels}
  \item By contrast, momentum \citep{jegadeesh1993} and accruals \citep{sloan1996} are genuine within firm claims, there the prediction alpha is the right benchmark
\eit
\svs
\lead{Suggestions}
\bit\itemsep2pt
  \item Frame the verdicts by what each strand claimed, the wedge debunks a signal claim yet confirms a type claim
  \item Reserve \emph{bias} for strands that claimed prediction
\eit
\end{frame}
...
\bit\itemsep2pt
  ...
  \item Point 1 \quad the wedge is a bias for signal claims yet not for type claims, tie each verdict to what the strand claimed
